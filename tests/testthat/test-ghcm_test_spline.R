...
test_that("ghcm_runs_with_two_irregular_inputs", {
  tst <- ghcm_test_spline(resid_X_on_Z_irregular, resid_Y_on_Z_irregular, c(0,1), c(0,2))
  expect_is(tst, "ghcm")
})

test_that("ghcm_runs_with_one_regular_and_one_irregular_input", {
  tst <- ghcm_test_spline(resid_X_on_Z_multivariate, resid_Y_on_Z_irregular,  Y_limits=c(0,2))
  expect_is(tst, "ghcm")
})

test_that("ghcm_runs_with_two_regular_inputs", {
  tst <- ghcm_test_spline(resid_X_on_Z_multivariate, resid_Y_on_Z_scalar)
  expect_is(tst, "ghcm")
})
...
test_that("ghcm_fails_when_sample_sizes_differ_irregular", {
  ...
  expect_error({
    ghcm_test_spline(resid_X_on_Z_irregular_half, resid_Y_on_Z_irregular)
  })
})
...
test_that("ghcm_fails_when_sample_sizes_differ_irregular_and_regular", {
  ...
  expect_error({
    ghcm_test_spline(resid_X_on_Z_multivariate_half, resid_Y_on_Z_irregular)
  })
})
...
test_that("ghcm_fails_when_bad_X_limits_single_number", {
  ...
  expect_error({
    ghcm_test_spline(resid_X_on_Z_irregular, resid_Y_on_Z_irregular, 0, c(0,2))
  })
})
...
test_that("ghcm_fails_when_bad_X_limits_bad_interval", {
  ...
  expect_error({
    ghcm_test_spline(resid_X_on_Z_irregular, resid_Y_on_Z_irregular, c(1,0), c(0,2))
  })
})
...
test_that("ghcm_fails_when_bad_X_limits_single_number", {
  ...
  expect_error({
    ghcm_test_spline(resid_X_on_Z_irregular, resid_Y_on_Z_irregular, c(0,1), 0)
  })
})
...
test_that("ghcm_fails_when_bad_X_limits_bad_interval", {
  ...
  expect_error({
    ghcm_test_spline(resid_X_on_Z_irregular, resid_Y_on_Z_irregular, c(0,2), c(1,0))
  })
})
...
test_that("ghcm_fails_when_bad_resid_X", {
  ...
  expect_error({
    ghcm_test_spline(bad_resid_X_on_Z_irregular, resid_Y_on_Z_irregular, c(0,2), c(0,1))
  })
})
...
test_that("ghcm_fails_when_bad_resid_Y", {
  ...
  expect_error({
    ghcm_test_spline(resid_X_on_Z_irregular, bad_resid_Y_on_Z_irregular, c(0,2), c(0,1))
  })
})
